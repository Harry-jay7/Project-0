(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[34], {
    3171: function (e, t, n) {
        var o, r, i, a, s, u, d, l, _, c, p, f, h, m, v;
        (r = function () {
            this.init()
        }
        ).prototype = {
            ...
            (a = function (e) {
                ...
                play: function (e, t) {
                    ...
                    var d = Math.max(0, s._seek > 0 ? s._seek : n._sprite[e][0] / 1e3)
                        , l = Math.max(0, (n._sprite[e][0] + n._sprite[e][1]) / 1e3 - d)
                        , _ = 1e3 * l / Math.abs(s._rate)
                        , c = n._sprite[e][0] / 1e3
                    ...
                    if (n._webAudio) {
                        var m = function () {
                            ...
                            h.gain.setValueAtTime(e, i.ctx.currentTime),
                                ...
                                void 0 === h.bufferSource.start ? s._loop ? h.bufferSource.noteGrainOn(0, d, 86400) : h.bufferSource.noteGrainOn(0, d, l) : s._loop ? h.bufferSource.start(0, d, 86400) : h.bufferSource.start(0, d, l),
                                _ !== 1 / 0 && (n._endTimers[s._id] = setTimeout(n._ended.bind(n, s), _)),
                        ...
                        var v = function () {
                            ...
                            try {
                                ...
                                "__default" !== e || s._loop ? n._endTimers[s._id] = setTimeout(n._ended.bind(n, s), _) : (n._endTimers[s._id] = function () {
                                    n._ended(s),
                        ...
                        "data:audio/wav;base64,UklGRigAAABXQVZFZm10IBIAAAABAAEARKwAAIhYAQACABAAAABkYXRhAgAAAAEA" === h.src && (h.src = n._src,
                            h.load());
                        var y = window && window.ejecta || !h.readyState && i._navigator.isCocoonJS;
                        if (h.readyState >= 3 || y)
                            v();
                        else {
                            n._playLock = !0,
                            ...
                            var g = function () {
                                n._state = "loaded",
                                    v(),
                                    h.removeEventListener(i._canPlayEvent, g, !1)
                            };
                            h.addEventListener(i._canPlayEvent, g, !1),
                                n._clearTimer(s._id)
                        }
                    }
                    return s._id
                ...
                seek: function () {
                    ...
                    if (r) {
                        if ("number" == typeof e && e >= 0) {
                            ...
                            return r._seek + (l + d * Math.abs(r._rate))
                        }
                    }
                    return n
                },
    ...
    5943: function (e, t, n) {
        ...
        var l = function (e) {
            function t(e) {
                ...
                return n.initHowler = n.initHowler.bind(n),
                    n
            }
            return !function (e, t) {
                ...
                o(t, [{
                    ...
                    value: function (e) {
                        JSON.stringify(e.src) !== JSON.stringify(this.props.src) ? this.initHowler(this.props) : this.toggleHowler(e)
                    }
                }, {
                    ...
                    value: function () {
                        ...
                        this.destroyHowler(),
                            void 0 !== s.Howl && (this.howler = new s.Howl({
                                src: e.src,
                                xhr: e.xhr,
                                format: e.format,
                                mute: e.mute,
                    ...
                    value: function (e) {
                        this.props.playing ? this.play() : this.pause(),
                            ...
                            e.volume !== this.props.volume && this.volume(this.props.volume),
                            this.props.preload && "unloaded" === this.howlerState() && this.load()
                    }
                }, {
                    key: "play",
                    value: function () {
                        this.howler.playing() || ("unloaded" === this.howlerState() && this.load(),
                            this.howler.play())
                    }
                }, {
                    key: "pause",
                    ...
                    value: function () {
                        ...
                        "number" == typeof e && (t ? this.howler.rate(e, t) : this.howler.rate(e))
                    }
                }, {
                    key: "howlerState",
                    value: function () {
                    ...
                    value: function () {
                        ...
                        return this.howler ? e || 0 === e ? e || 0 === e ? (this.howler.seek(e),
                            e) : void 0 : this.howler.seek() : 0
                    }
                }, {
                    key: "duration",
                    value: function () {
        ...
        l.propTypes = {
            src: a.default.oneOfType([a.default.string, a.default.arrayOf(a.default.string)]).isRequired,
            format: a.default.arrayOf(a.default.string),
            xhr: a.default.object,
            playing: a.default.bool,
            mute: a.default.bool,
            loop: a.default.bool,
            preload: a.default.bool,
            volume: a.default.number,
            rate: a.default.number,
            onEnd: a.default.func,
            onPause: a.default.func,
            onPlay: a.default.func,
            onPlayError: a.default.func,
            onVolume: a.default.func,
            onStop: a.default.func,
            onLoad: a.default.func,
            onSeek: a.default.func,
            onLoadError: a.default.func,
            html5: a.default.bool
        },
            l.defaultProps = {
                playing: !0,
                format: [],
    ...
    6679: function (e, t, n) {
        "use strict";
        var o = void 0;
        "undefined" != typeof window && (o = n(3171)),
            e.exports = o
    },
    4344: function (e, t, n) {
        "use strict";
        e.exports = n(5943).default
    },
    9494: function (e, t) {
        "use strict";
        Object.defineProperty(t, "__esModule", {
